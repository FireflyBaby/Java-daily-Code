...
public class EchoClient {
    private static final BufferedReader KEYBOARD_INPOT=new BufferedReader(new InputStreamReader(System.in));
    public static void main(String[] args) throws Exception{
        Socket client = new Socket("localhost",9999);//定义服务端的连接信息
        //现在的客户端需要有输入与输出的操作支持，所以依然要准备Scanner与PrintWriter
        Scanner scan = new Scanner(client.getInputStream());//接收服务器端的内容
        scan.useDelimiter("\n");
    ...
    public static String getString(String prompt) throws Exception{
        ...
        String str=KEYBOARD_INPOT.readLine();
        return str;
    }
}
